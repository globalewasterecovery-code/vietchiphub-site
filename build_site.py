...
INTENT_PAGES = [
    ("chip-thieu-hang", "Chip thiếu hàng tại Việt Nam", "Gửi danh sách chip thiếu hàng, số lượng và thời hạn để kiểm tra nguồn cung, date code và phương án thay thế có kiểm soát."),
    ("linh-kien-ngung-san-xuat", "Linh kiện ngừng sản xuất và khó tìm", "Tìm linh kiện EOL, obsolete và hard-to-find bằng quy trình kiểm tra nhãn, lô hàng, nguồn gốc và phương án thay thế."),
    ("chip-bi-han-che-xuat-khau", "Thông tin chip bị hạn chế xuất khẩu", "Trang thông tin và tiếp nhận nhu cầu có kiểm tra tuân thủ đối với chip điện toán tiên tiến hoặc mặt hàng có thể cần giấy phép."),
    ("chip-co-san-viet-nam", "Chip có sẵn và hàng tồn kho tại Việt Nam", "Đăng nhu cầu hoặc hàng tồn kho chip tại Việt Nam; mọi trạng thái có sẵn phải được xác nhận tại thời điểm báo giá."),
]

MEMORY_PAGES = [
    ("bo-nho", "Thị trường bộ nhớ và nguồn cung tại Việt Nam", "Theo dõi tín hiệu cung cầu DRAM, NAND, HBM, RAM máy chủ và SSD doanh nghiệp; gửi nhu cầu thực để được rà soát nguồn cung.", "Tổng quan bộ nhớ", "DRAM · NAND · HBM · Server RAM · Enterprise SSD"),
    ("bo-nho/gia-ram-tang-2026", "Giá RAM tăng năm 2026: doanh nghiệp cần chuẩn bị gì?", "Giải thích nguyên nhân giá RAM tăng, tác động của nhu cầu AI và cách chuẩn bị RFQ, dự báo và lịch giao hàng.", "Tín hiệu giá RAM 2026", "Không phải bảng giá thời gian thực; giá được xác nhận theo từng mã và thời điểm."),
    ("bo-nho/gia-dram-hom-nay", "Giá DRAM hôm nay và cách yêu cầu báo giá", "Trang hướng dẫn kiểm tra giá DRAM theo mã chip, dung lượng, tốc độ, date code, số lượng và điều kiện giao hàng tại Việt Nam.", "Yêu cầu giá DRAM", "Giá DRAM biến động; cần mã đầy đủ và báo giá có thời hạn hiệu lực."),
    ("bo-nho/thieu-chip-nho", "Thiếu chip nhớ: DRAM và NAND tại Việt Nam", "Thông tin về tình trạng thiếu chip nhớ và kênh đăng nhu cầu DRAM, NAND Flash, RAM server và SSD doanh nghiệp.", "Thiếu chip nhớ", "Ưu tiên yêu cầu có mã, số lượng, lịch cần hàng và phương án thay thế được phép."),
    ("bo-nho/ddr5-rdimm-ecc", "DDR5 RDIMM ECC cho máy chủ tại Việt Nam", "Tìm nguồn RAM server DDR5 RDIMM ECC theo dung lượng, tốc độ, rank, hãng, số lượng và nền tảng máy chủ.", "RAM server DDR5 RDIMM ECC", "Cần xác nhận tương thích bo mạch chủ, CPU, rank, điện áp và firmware."),
    ("bo-nho/ddr4-server", "RAM server DDR4 ECC tại Việt Nam", "Đăng nhu cầu DDR4 RDIMM, LRDIMM và ECC cho bảo trì máy chủ, trung tâm dữ liệu và hệ thống công nghiệp.", "RAM server DDR4", "Phân biệt RDIMM, LRDIMM, UDIMM; không thay thế chéo nếu chưa xác nhận."),
    ("bo-nho/nand-flash", "Nguồn cung NAND Flash tại Việt Nam", "Tìm NAND Flash theo loại SLC, MLC, TLC, dung lượng, package, nhiệt độ và yêu cầu vòng đời sản phẩm.", "NAND Flash", "Thiết kế công nghiệp cần kiểm tra controller, ECC, firmware và vòng đời."),
    ("bo-nho/ssd-doanh-nghiep", "SSD doanh nghiệp và eSSD tại Việt Nam", "Yêu cầu báo giá SSD doanh nghiệp theo giao tiếp, dung lượng, DWPD, form factor và chứng từ nguồn gốc.", "Enterprise SSD / eSSD", "Ghi rõ NVMe hoặc SATA, U.2/U.3/E1.S, workload và yêu cầu bảo hành."),
    ("bo-nho/hbm3e-hbm4", "HBM3E và HBM4 cho hạ tầng AI", "Thông tin nhu cầu HBM cho hệ thống AI và HPC; mọi yêu cầu phải qua kiểm tra cấu hình, bên sử dụng cuối và tuân thủ xuất khẩu.", "HBM3E / HBM4", "Sản phẩm điện toán tiên tiến có thể chịu kiểm soát xuất khẩu và phân bổ nguồn cung."),
    ("bo-nho/samsung-sk-hynix-micron", "Chip nhớ Samsung, SK hynix và Micron", "Đăng RFQ bộ nhớ theo đúng mã của Samsung, SK hynix hoặc Micron; kiểm tra nhãn, date code, package và nguồn gốc.", "Nhà sản xuất bộ nhớ", "Tên hãng không đủ để báo giá: bắt buộc có mã linh kiện hoặc thông số thay thế."),
]

OPPORTUNITY_PAGES = [
    ("module-igbt-cong-nghiep", "Module IGBT công nghiệp tại Việt Nam", "Infineon FS/FF, Mitsubishi CM/PM, Fuji 6MBI", "Biến tần, servo, UPS và thiết bị điện công suất thường cần đúng module và giao nhanh khi dừng máy."),
    ("module-sic-mosfet", "Module SiC MOSFET tại Việt Nam", "Infineon CoolSiC, Wolfspeed, onsemi, ROHM", "Thiết bị sạc nhanh, năng lượng và truyền động hiệu suất cao cần kiểm tra điện áp, dòng, package và driver tương thích."),
    ("ipm-module-cong-suat", "IPM và module công suất thông minh", "Mitsubishi DIPIPM, Infineon CIPOS, Fuji IPM", "Điều hòa, máy nén, servo và thiết bị gia dụng công nghiệp thường mua theo đúng mã module."),
    ("mcu-o-to-s32k144", "NXP S32K144 và MCU ô tô tại Việt Nam", "S32K144, S32K1, CAN/LIN automotive MCU", "Nhu cầu sửa chữa, thử nghiệm và sản xuất ô tô cần đúng grade, package, marking và truy xuất nguồn gốc."),
    ("aurix-tc3xx", "Infineon AURIX TC3xx tại Việt Nam", "TC33x, TC36x, TC37x, TC38x, TC39x", "MCU an toàn chức năng cho ô tô và công nghiệp; mã đầy đủ và mục đích sử dụng phải được kiểm tra."),
    ("dsp-c2000-dieu-khien", "TI C2000 DSP cho biến tần và điều khiển", "TMS320F28335, F2806x, F2837x", "Các hệ thống điều khiển thời gian thực, motor drive và nguồn số thường phụ thuộc vào đúng biến thể DSP."),
    ("module-4g-lte", "Module 4G LTE cho IoT tại Việt Nam", "Quectel EC200U, EG25-G; SIMCom A7670, SIM7600", "Thiết bị IoT cần chọn đúng băng tần, chứng nhận, firmware, giao tiếp và biến thể khu vực."),
    ("module-gnss-gps", "Module GNSS và GPS tại Việt Nam", "u-blox NEO/M10; Quectel LC/MC series", "Theo dõi xe, logistics và IoT cần kiểm tra constellation, antenna, độ chính xác và firmware."),
    ("module-wifi-bluetooth", "Module Wi-Fi và Bluetooth tại Việt Nam", "ESP32-S3, ESP32-C3, module công nghiệp Wi-Fi/BT", "Sản phẩm IoT và tự động hóa cần đúng module, flash/PSRAM, antenna và chứng nhận RF."),
    ("fpga-cong-nghiep", "FPGA công nghiệp và linh kiện lập trình", "AMD Xilinx Spartan/Artix/Zynq; Intel Cyclone", "Thiết bị công nghiệp cũ và dự án điều khiển cần đúng speed grade, package, nhiệt độ và trạng thái vòng đời."),
    ("ic-cach-ly-gate-driver", "IC cách ly và gate driver công suất", "TI ISO/UCC, Infineon EiceDRIVER, Broadcom isolation", "Biến tần và nguồn công suất cần đối chiếu điện áp cách ly, CMTI, dòng drive và chứng nhận an toàn."),
    ("plc-servo-module", "Module PLC và servo thay thế tại Việt Nam", "Mitsubishi, Siemens, Omron, Yaskawa", "Phụ tùng dừng máy có giá trị theo thời gian giao; phải xác nhận model, revision, firmware và tình trạng mới hoặc đã qua sử dụng."),
    ("bo-mach-may-cong-nghiep", "Bo mạch máy công nghiệp và bo sửa chữa", "CNC, textile, SMT, inverter, automation boards", "Bo ngừng sản xuất có thể được tìm theo mã PCB, phiên bản, hình ảnh đầu nối và máy sử dụng."),
]
...
def localized_page(lang, prefix, path, title, desc, heading):
    ...
    if path == "rfq":
        ...
        traffic = '''<section><div class="wrap"><h2>Nhu cầu linh kiện đang được quan tâm</h2><p class="lead">Đi thẳng đến nhóm sản phẩm, tình trạng thiếu hàng hoặc yêu cầu báo giá phù hợp.</p><div class="grid"><article class="card"><span class="tag">Bộ nhớ</span><h3>DRAM, NAND, HBM và RAM server</h3><p>Thông tin giá, thiếu hàng, DDR5 RDIMM ECC và SSD doanh nghiệp.</p><a href="/bo-nho/">Xem trung tâm bộ nhớ →</a></article><article class="card"><span class="tag">Công nghiệp</span><h3>IGBT, SiC, IPM và bo mạch</h3><p>Tìm đúng module cho biến tần, servo, UPS và máy công nghiệp.</p><a href="/linh-kien/">Xem linh kiện công nghiệp →</a></article><article class="card"><span class="tag">Khan hiếm</span><h3>Chip thiếu hàng và linh kiện EOL</h3><p>Gửi mã khó tìm, ngừng sản xuất hoặc cần thay thế khẩn cấp.</p><a href="/chip-thieu-hang/">Xem nhu cầu thiếu hàng →</a></article></div></div></section>''' if vi else ''
        core = f'''<section class="hero"><div class="wrap hero-grid"><div class="hero-copy"><div class="eyebrow">{labels['supply']}</div><h1>{escape(title)}</h1><p>{escape(desc)}</p><div class="actions"><a class="btn" href="{base}/rfq/">{labels['start']}</a><a class="btn alt" href="{base}/suppliers/">{labels['suppliers']}</a></div></div><aside class="signal"><span>RFQ</span><b>BOM · IC · MCU</b><span>IGBT · Bo mạch / 板卡 · Linh kiện / 元器件</span></aside></div></section><section class="soft"><div class="wrap"><h2>{labels['components']}</h2><p class="lead">{labels['intro']}</p><div class="grid">{''.join(f'<article class="card"><h3>{escape(t)}</h3><p>{escape(d)}</p><a href="{base}/{p}/">{labels["start"]} →</a></article>' for p,t,d,h in (VI_PAGES if vi else ZH_PAGES)[4:10])}</div></div></section>{traffic}<section><div class="wrap cta"><h2>{labels['intro']}</h2><a class="btn" href="{base}/rfq/">{labels['rfq']}</a></div></section>'''
    else:
...
def intent_page(slug, title, desc):
    restricted = slug == "chip-bi-han-che-xuat-khau"
    policy = '''<p class="notice"><strong>Nguyên tắc:</strong> Mọi yêu cầu phải được kiểm tra phân loại hàng hóa, bên mua, bên sử dụng cuối, quốc gia đích, mục đích sử dụng và yêu cầu giấy phép. Không tiếp nhận yêu cầu né tránh kiểm soát xuất khẩu.</p>''' if restricted else '''<p class="notice">Tình trạng thiếu hàng, EOL hoặc có sẵn phải được xác nhận bằng dữ liệu tại thời điểm yêu cầu; tiêu đề tìm kiếm không phải là tuyên bố tồn kho.</p>'''
    cards = ''.join(f'<article class="card"><span class="tag">{c["group"]}</span><h3>{c["name"]}</h3><p>{c["status"]}</p><a href="/chip/{c["slug"]}/">Xem dữ liệu →</a></article>' for c in CHIPS)
    core = f'''<main><section class="pagehero"><div class="wrap"><div class="crumb"><a href="/">Trang chủ</a> / {title}</div><span class="eyebrow">Nhu cầu linh kiện tại Việt Nam</span><h1>{title}</h1><p>{desc}</p><a class="btn" href="/rfq/">Gửi danh sách linh kiện</a></div></section><section><div class="wrap"><h2>Dữ liệu và mã linh kiện tham khảo</h2><p class="lead">Các trang dưới đây dùng thông tin sản phẩm từ nhà sản xuất; tồn kho và khả năng giao dịch được kiểm tra riêng.</p><div class="grid">{cards}</div></div></section><section class="soft"><div class="wrap"><h2>Quy trình tiếp nhận</h2>{policy}<div class="steps"><div class="step"><h3>Gửi mã và số lượng</h3><p>Đính kèm hãng, hậu tố, date code, giá mục tiêu và ngày cần hàng.</p></div><div class="step"><h3>Kiểm tra dữ liệu</h3><p>Đối chiếu thông số hãng, tình trạng sản phẩm và bằng chứng nguồn cung.</p></div><div class="step"><h3>Phản hồi thủ công</h3><p>Chỉ chuyển tiếp phương án phù hợp sau khi kiểm tra điều kiện kỹ thuật và tuân thủ.</p></div></div></div></section></main>'''
    return shell(title,desc,slug,core).replace('<html lang="en">','<html lang="vi">').replace('Submit RFQ','Gửi RFQ')

def memory_page(path, title, desc, topic, note):
    canonical = f"{DOMAIN}/{path}/"
    related = ''.join(f'<article class="card"><span class="tag">Nhu cầu bộ nhớ</span><h3>{t}</h3><p>{d}</p><a href="/{p}/">Xem chủ đề →</a></article>' for p,t,d,_,_ in MEMORY_PAGES if p != path)
    schema = '{"@context":"https://schema.org","@type":"TechArticle","headline":"%s","description":"%s","inLanguage":"vi","dateModified":"%s","mainEntityOfPage":"%s","publisher":{"@type":"Organization","name":"VN Electronics Hub"}}' % (title,desc,date.today().isoformat(),canonical)
    body = f'''<main><section class="pagehero"><div class="wrap"><div class="crumb"><a href="/">Trang chủ</a> / <a href="/bo-nho/">Bộ nhớ</a> / {topic}</div><span class="eyebrow">DRAM · NAND · HBM · SSD</span><h1>{title}</h1><p>{desc}</p><div class="actions"><a class="btn" href="/rfq/?category=memory">Gửi RFQ bộ nhớ</a><a class="btn alt" href="#memory-topics">Xem chủ đề liên quan</a></div></div></section><div class="trust"><div class="wrap"><span>✓ Cập nhật: {date.today().isoformat()}</span><span>✓ Không công bố tồn kho giả</span><span>✓ Báo giá theo mã và thời điểm</span><span>✓ Kiểm tra tuân thủ</span></div></div><section><div class="wrap split"><div><h2>{topic}</h2><p class="lead">Nhu cầu AI và trung tâm dữ liệu đang làm thay đổi phân bổ công suất cho HBM, DRAM máy chủ và SSD doanh nghiệp. Người mua nên gửi dự báo sớm, nhưng chỉ quyết định dựa trên báo giá và bằng chứng nguồn cung còn hiệu lực.</p><p class="notice"><strong>Lưu ý dữ liệu:</strong> {note}</p><h2 style="margin-top:34px">Thông tin giúp nhận báo giá nhanh hơn</h2><div class="steps"><div class="step"><h3>Mã và cấu hình đầy đủ</h3><p>Hãng, part number, dung lượng, tốc độ, package, rank, form factor và tiêu chuẩn nhiệt độ.</p></div><div class="step"><h3>Số lượng và lịch giao</h3><p>Số lượng thử mẫu, sản lượng tháng, thời điểm cần hàng và địa điểm giao tại Việt Nam.</p></div><div class="step"><h3>Điều kiện chấp nhận</h3><p>Date code, tình trạng, truy xuất nguồn gốc, test report, bảo hành và linh kiện thay thế được phép.</p></div></div></div><aside class="panel"><span class="eyebrow">RFQ bộ nhớ</span><h2>Có nhu cầu thực?</h2><p>Gửi 5–10 dòng ưu tiên trước. Đội ngũ sẽ rà soát cấu trúc yêu cầu và phản hồi bằng email hoặc thông tin liên hệ bạn cung cấp.</p><a class="btn" href="/rfq/?category=memory">Gửi mã và số lượng</a></aside></div></section><section class="soft" id="memory-topics"><div class="wrap"><h2>Cụm từ mua hàng liên quan</h2><p class="lead">Các trang được tách theo ý định tìm kiếm để người mua đi thẳng đến đúng biểu mẫu.</p><div class="grid">{related}</div></div></section><section><div class="wrap faq"><h2>Câu hỏi thường gặp</h2><details><summary>Trang có báo giá RAM hoặc DRAM theo thời gian thực không?</summary><p>Không. Giá thay đổi theo mã, số lượng, date code, điều kiện giao và thời hạn báo giá. Trang chỉ cung cấp tín hiệu thị trường và kênh RFQ.</p></details><details><summary>Có thể gửi BOM hoặc bảng danh sách không?</summary><p>Có. Hãy gửi các dòng ưu tiên trước; chức năng tải BOM sẽ được bổ sung sau khi luồng kiểm tra tệp hoàn tất.</p></details><details><summary>Có chấp nhận bộ nhớ thay thế khác hãng không?</summary><p>Chỉ khi người mua và kỹ sư xác nhận tương thích. Không tự động thay đổi hãng, rank, tốc độ hoặc cấp nhiệt độ.</p></details></div></section></main>'''
    top = nav().replace("Submit RFQ","Gửi RFQ").replace("Components","Linh kiện").replace("BOM Sourcing","Tìm nguồn BOM").replace("Surplus","Hàng tồn kho").replace("Suppliers","Nhà cung cấp").replace("Quality","Chất lượng")
    return f'''<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{escape(title)} | VN Electronics Hub</title><meta name="description" content="{escape(desc)}"><link rel="canonical" href="{canonical}"><meta property="og:title" content="{escape(title)}"><meta property="og:description" content="{escape(desc)}"><meta property="og:url" content="{canonical}"><script type="application/ld+json">{schema}</script><link rel="stylesheet" href="/assets/site.css"></head><body>{top}{body}{footer()}</body></html>'''

def opportunity_page(slug, title, models, reason):
    path = f"linh-kien/{slug}"
    desc = f"Tìm {title.lower()} tại Việt Nam; tham khảo các dòng {models}. Gửi mã, số lượng và thời hạn để được kiểm tra khả năng cung ứng và giao hàng."
    canonical = f"{DOMAIN}/{path}/"
    schema = '{"@context":"https://schema.org","@type":"CollectionPage","name":"%s","description":"%s","inLanguage":"vi","url":"%s"}' % (title,desc,canonical)
    body = f'''<main><section class="pagehero"><div class="wrap"><div class="crumb"><a href="/">Trang chủ</a> / <a href="/components/">Linh kiện</a> / {title}</div><span class="eyebrow">Tìm linh kiện · Xác minh thông tin · Giao hàng Việt Nam</span><h1>{title}</h1><p>{desc}</p><div class="actions"><a class="btn" href="/rfq/?category={slug}">Gửi mã cần mua</a><a class="btn alt" href="/quality/">Quy trình xác minh</a></div></div></section><section><div class="wrap split"><div><h2>Dòng sản phẩm thường được hỏi</h2><p class="lead">{models}</p><div class="grid"><article class="card"><span class="tag">Nhu cầu</span><h3>Thay thế khẩn cấp</h3><p>{reason}</p></article><article class="card"><span class="tag">Xác minh</span><h3>Đúng mã và phiên bản</h3><p>Đối chiếu hậu tố, package, revision, firmware, grade, date code và ảnh nhãn.</p></article><article class="card"><span class="tag">Phản hồi</span><h3>Báo giá theo yêu cầu</h3><p>Phản hồi dựa trên mã đầy đủ, số lượng, tình trạng, thời hạn và địa điểm giao hàng.</p></article></div></div></div></section><section class="soft"><div class="wrap"><h2>Gửi yêu cầu để nhận phản hồi phù hợp</h2><div class="steps"><div class="step"><h3>Gửi mã linh kiện</h3><p>Điền part number đầy đủ, hãng, hậu tố và hình ảnh nếu có.</p></div><div class="step"><h3>Nêu số lượng và thời hạn</h3><p>Cho biết số lượng thử mẫu, sản lượng dự kiến và ngày cần hàng.</p></div><div class="step"><h3>Xác nhận yêu cầu kỹ thuật</h3><p>Ghi rõ tình trạng, date code, revision, firmware, chứng từ và tiêu chuẩn kiểm tra.</p></div></div><p class="notice"><strong>Thông tin minh bạch cho người mua:</strong> Tồn kho và báo giá chỉ được xác nhận sau khi đội ngũ kiểm tra yêu cầu cụ thể. Không tự động thay thế mã hoặc thay đổi thông số.</p><a class="btn" href="/rfq/?category={slug}">Gửi RFQ</a></div></section></main>'''
    top = nav().replace("Submit RFQ","Gửi RFQ").replace("Components","Linh kiện").replace("BOM Sourcing","Tìm nguồn BOM").replace("Surplus","Hàng tồn kho").replace("Suppliers","Nhà cung cấp").replace("Quality","Chất lượng")
    return f'''<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{escape(title)} | VN Electronics Hub</title><meta name="description" content="{escape(desc)}"><link rel="canonical" href="{canonical}"><meta property="og:title" content="{escape(title)}"><meta property="og:description" content="{escape(desc)}"><script type="application/ld+json">{schema}</script><link rel="stylesheet" href="/assets/site.css"></head><body>{top}{body}{footer()}</body></html>'''

def sourcing_hub():
    canonical = f"{DOMAIN}/linh-kien/"
    cards = ''.join(f'<article class="card"><span class="tag">Tìm linh kiện</span><h3>{title}</h3><p>{models}</p><a href="/linh-kien/{slug}/">Xem sản phẩm và gửi RFQ →</a></article>' for slug,title,models,_ in OPPORTUNITY_PAGES)
    body = f'''<main><section class="pagehero"><div class="wrap"><span class="eyebrow">Linh kiện điện tử và module công nghiệp</span><h1>Tìm chip, module và bo mạch tại Việt Nam</h1><p>Tìm đúng mã linh kiện cho sản xuất, bảo trì và sửa chữa: IGBT, SiC, IPM, MCU ô tô, DSP, module 4G/GNSS, FPGA, PLC và bo mạch máy công nghiệp.</p><div class="actions"><a class="btn" href="/rfq/">Gửi mã cần mua</a><a class="btn alt" href="/chip-thieu-hang/">Chip thiếu hàng</a></div></div></section><section class="soft"><div class="wrap"><h2>Nhóm linh kiện có nhu cầu cao</h2><p class="lead">Chọn nhóm gần nhất với nhu cầu. Nếu chưa rõ, gửi hình ảnh nhãn, mã PCB hoặc BOM để đội ngũ phân loại.</p><div class="grid">{cards}</div></div></section><section><div class="wrap cta"><h2>Cần gấp một mã linh kiện hoặc module thay thế?</h2><a class="btn" href="/rfq/">Gửi RFQ ngay</a></div></section></main>'''
    schema = '{"@context":"https://schema.org","@type":"CollectionPage","name":"Linh kiện điện tử và module công nghiệp tại Việt Nam","inLanguage":"vi","url":"%s"}' % canonical
    top = nav().replace("Submit RFQ","Gửi RFQ").replace('href="/components/"','href="/linh-kien/"').replace("Components","Linh kiện").replace("BOM Sourcing","Tìm nguồn BOM").replace("Surplus","Hàng tồn kho").replace("Suppliers","Nhà cung cấp").replace("Quality","Chất lượng")
...
def build():
    ...
    for chip in CHIPS:
        target = OUT/"chip"/chip["slug"]; target.mkdir(parents=True,exist_ok=True)
        (target/"index.html").write_text(chip_page(chip),encoding="utf-8")
    for slug,title,desc in INTENT_PAGES:
        target = OUT/slug; target.mkdir(parents=True,exist_ok=True)
        (target/"index.html").write_text(intent_page(slug,title,desc),encoding="utf-8")
    for path,title,desc,topic,note in MEMORY_PAGES:
        target = OUT/path; target.mkdir(parents=True,exist_ok=True)
        (target/"index.html").write_text(memory_page(path,title,desc,topic,note),encoding="utf-8")
    for slug,title,models,reason in OPPORTUNITY_PAGES:
        target = OUT/"linh-kien"/slug; target.mkdir(parents=True,exist_ok=True)
    ...
    urls += [f"{DOMAIN}/chip/{chip['slug']}/" for chip in CHIPS]
    urls += [f"{DOMAIN}/{slug}/" for slug,*_ in INTENT_PAGES]
